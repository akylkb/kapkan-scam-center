...
| `/drops?seat=N` | Рабочее место дроповода | Отдел вывода, **у каждой машины свой N** |
| `/chat?seat=N` | Рабочее место чатера (мессенджеры) | Отдел переписки, **у каждой машины свой N** |
...
```
app/                  пять экранов + служебный лаунчер
components/
